const GITHUB_URL = "https://github.com/aeldidi";
const LINKEDIN_URL = "https://linkedin.com/in/aeldidi";

export const SITE_META = {
  siteUrl: "https://ayman.eldidi.org",
  name: "Ayman El Didi",
  alternateName: "Ayman El Didi's Website",
  locale: "en_US",
  email: "ayman@eldidi.org",
  github: GITHUB_URL,
